...
<head>
    ...
    <asset:javascript src="advanced.js"/>
    <asset:stylesheet src="advanced.css"/>
</head>
<body>
    <div ng-controller="MainCtrl">
        <div>
            <input class="changeSortMode" type="button" value="Sort by playlist" onclick="window.location.href = '/'">
        </div>
        <br/>
        ...
        <div ng-model="data" ng-init="data = {}" ng-hide="showResults">
            ...
            <g:render template="/templates/series"/>
        </div>
    </div>
<section>
</section>
